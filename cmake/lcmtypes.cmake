...
if (LCM_FOUND)
  ...
  file(MAKE_DIRECTORY ${LCMTYPES_DIR})
...
function(add_c_lcmtype lcmtype)
  ...
  add_custom_command(OUTPUT "${LCMTYPES_DIR}/${lcmtype_we}.c" "${LCMTYPES_DIR}/${lcmtype_we}.h"
...
function(add_cpp_lcmtype lcmtype)
  ...
  string(REGEX REPLACE "${_package_name}_([A-aa-z0-9]+)" "\\1" filename_no_pkg ${lcmtype_we})

  add_custom_command(OUTPUT "${LCMTYPES_DIR}/${package_prefix}/${filename_no_pkg}.hpp"
  		     COMMAND ${LCM_GEN_EXECUTABLE} --cpp "${lcmtype}" --cpp-include lcmtypes
		     DEPENDS "${lcmtype}"
		     WORKING_DIRECTORY ${LCMTYPES_DIR})
  set(LCMTYPES_CPP_HEADERFILES ${LCMTYPES_CPP_HEADERFILES} "${LCMTYPES_DIR}/${package_prefix}/${filename_no_pkg}.hpp" PARENT_SCOPE)
...
function(add_java_lcmtype lcmtype)
  ...
  add_custom_command(OUTPUT "${LCMTYPES_DIR}/${package_prefix}/${filename_no_pkg}.java"
  		     COMMAND ${LCM_GEN_EXECUTABLE} --jdefaultpkg "lcmtypes" --java "${lcmtype}"
		     DEPENDS "${lcmtype}"
		     WORKING_DIRECTORY ${LCMTYPES_DIR})
  set(LCMTYPES_JAVA_SOURCEFILES ${LCMTYPES_JAVA_SOURCEFILES} "${LCMTYPES_DIR}/${package_prefix}/${filename_no_pkg}.java" PARENT_SCOPE)
...
function(add_python_lcmtype lcmtype)
  ...
  add_custom_command(OUTPUT "${LCMTYPES_DIR}/${package_prefix}/${filename_no_pkg}.py"
      		     COMMAND ${LCM_GEN_EXECUTABLE} --python "${lcmtype}"
		     DEPENDS "${lcmtype}"
		     WORKING_DIRECTORY ${LCMTYPES_DIR})

  set(LCMTYPES_PYTHON_FILES ${LCMTYPES_PYTHON_FILES} "${LCMTYPES_DIR}/${package_prefix}/${filename_no_pkg}.py" PARENT_SCOPE)
endfunction()
